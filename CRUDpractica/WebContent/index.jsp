			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-6">
							<h2>
								Gestión de <b>Huéspedes</b>
							</h2>
						</div>
						<div class="col-sm-6">
							<a href="#addEmployeeModal" class="btn btn-success"
								data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>
									Nuevo Cliente</span></a>
							<a href="/CRUDpractica/reservas.jsp" class="btn btn-primary"> 
							<span>Reservas</span>
							</a>
						</div>
					</div>
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<div class="d-flex flex-row">
							<form action="/CRUDpractica/editUser.jsp" method="post">
							<button type="submit" class="btn btn-warning" value="<%= rs.getInt("id") %>" name="idBotonEditar"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></button>
							</form>
							
							<form action="/CRUDpractica/deleteCliente" method="post">
							<button type="submit" class="btn btn-danger" value="<%= rs.getInt("id") %>" name="idButton"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button>
